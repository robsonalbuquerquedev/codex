...
import { bastidoresProducaoArticles } from "@/data/bastidoresProducaoArticles";

export default function BastidoresProducaoCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Decisões criativas, limitações técnicas, conflitos internos e
                    soluções inesperadas. Aqui você descobre o que aconteceu
                    longe dos holofotes e como esses bastidores moldaram obras
                    marcantes da cultura geek.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {bastidoresProducaoArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
