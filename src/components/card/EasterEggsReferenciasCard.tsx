...
import { easterEggsReferenciasArticles } from "@/data/easterEggsReferenciasArticles";

export default function EasterEggsReferenciasCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Detalhes escondidos, callbacks visuais e referências sutis
                    que passam despercebidos à primeira vista — até alguém
                    pausar o frame, reler o diálogo ou conectar os pontos.
                    Aqui, nada está ali por acaso.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {easterEggsReferenciasArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
