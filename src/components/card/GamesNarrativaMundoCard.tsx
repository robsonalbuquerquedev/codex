...
import { gamesNarrativaMundoArticles } from "@/data/gamesNarrativaMundoArticles";

export default function GamesNarrativaMundoCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Histórias, lore, personagens e a construção de universos que fazem alguns jogos
                    parecerem livros jogáveis.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {gamesNarrativaMundoArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
