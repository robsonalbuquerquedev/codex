...
import { indiesAutoraisArticles } from "@/data/indiesAutoraisArticles";

export default function IndiesAutoraisCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Experiências criativas, diferentes e cheias de personalidade — onde
                    a inovação costuma aparecer primeiro. Aqui você encontra análises
                    de jogos independentes, projetos autorais e ideias ousadas que
                    fogem do &quot;mais do mesmo&quot;.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {indiesAutoraisArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
