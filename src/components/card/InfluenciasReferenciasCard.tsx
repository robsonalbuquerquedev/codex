...
import { influenciasReferenciasArticles } from "@/data/influenciasReferenciasArticles";

export default function InfluenciasReferenciasCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Mapas de inspiração que revelam o que está por trás das
                    narrativas e estéticas: mitologia, literatura, cinema,
                    política, tecnologia e ideias que atravessam gerações e
                    moldam universos criativos.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {influenciasReferenciasArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
