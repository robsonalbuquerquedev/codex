...
import { onepieceArticles } from "@/data/onepieceArticles";

export default function OnePieceCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Análises completas, críticas e reflexões sobre a adaptação
                    live-action de One Piece, explorando narrativa, personagens
