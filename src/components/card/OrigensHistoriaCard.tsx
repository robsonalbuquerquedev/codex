...
import { origensHistoriaArticles } from "@/data/origensHistoriaArticles";
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Um panorama histórico das HQs e dos mangás, explorando movimentos,
                    marcos criativos e como cada era moldou a linguagem dos quadrinhos
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {origensHistoriaArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
