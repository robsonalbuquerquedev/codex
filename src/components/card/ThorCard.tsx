...
import { thorArticles } from "@/data/thorArticles";
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Análises narrativas e críticas sobre as diferentes representações de Thor
                    no cinema, explorando sua mitologia, conflitos internos, evolução como herói
                    e o impacto cultural do personagem dentro do universo Marvel.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {thorArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
