...
import { universosContinuidadesArticles } from "@/data/universosContinuidadesArticles";

export default function UniversosContinuidadesCard() {
    return (
            ...
            <header className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight">
                        Universos & Continuidades
                    </h2>
                </div>

                <p className="text-muted-foreground max-w-3xl">
                    Cânone, reboots, linhas do tempo e conexões narrativas:
                    uma análise de como universos compartilhados se expandem,
                    se reorganizam e permanecem compreensíveis sem virar bagunça.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {universosContinuidadesArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
